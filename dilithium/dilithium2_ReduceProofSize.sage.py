...
def HIGH_s(w, s=_sage_const_2 **_sage_const_16 ):
    w_high = []
    for x in w:
        w_high.append(PR([ZZ(coef) // s for coef in x.list()]))
    return w_high

def LOW_s(w, s=_sage_const_2 **_sage_const_16 ):
    w_low = []
    for x in w:
